...
namespace Assignment2.Controllers {
    ...
    public class PropertiesController : ControllerBase {
        ...
        [HttpGet("filter")]
        public async Task<PagingList<Property>> FilterProperties([FromQuery] int PageNum, int PageLimit, int? FromPrice, int? ToPrice, string Address, int? NumberOfRooms) {
            ...
            return await PagingList.CreateAsync(properties.OrderByDescending(p => p.Price), PageLimit, PageNum);
        }
